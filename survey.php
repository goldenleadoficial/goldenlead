...
<?php
						$mail = $_POST['email'];
						$to = "<goldenlead.contato@gmail.com>";/* YOUR EMAIL HERE */
						$subject = "Informações para Reunião - GoldenLEAD";
						$headers = 'From: Informações para Reunião <noreply@satisfyc.com>' . "\r\n" . 'Reply-To: <noreply@satisfyc.com>';
						$message = "DETALHES\n";
						...
						//Confirmation page
						$user = "$mail";
						$usersubject = "Informações para Reunião - GoldenLEAD";
						$userheaders = "De: goldenlead.contato@gmail.com\n";
						/*$usermessage = "Thank you for your time. Your quotation request is successfully submitted.\n"; WITH OUT SUMMARY*/
						//Confirmation page WITH  SUMMARY
						$usermessage = "Obrigado pelo seu tempo. Seu email foi enviado com sucesso. Retornaremos em breve.\n\nAbaixo um Resumo\n\n$message"; 
...
<div id="success">
	...
	<h4><span>Pedido enviado com Sucesso! </span>Obrigado pelo seu tempo</h4>
	<small>Você será redirecionado de volta em 5 segundos.</small>
</div>
</body>
</html>